...
TEXTO_MENU = (
    ...
    "*── Control de números (detener/reactivar) ──*\n"
    "*stop:* [número] — Detiene al agente con ese cliente (no responde)\n"
    "*on:* [número] — Reactiva al agente con ese cliente\n"
    "*unblock:* [número] — Reactiva (igual que 'on')\n"
    "*stopped* — Lista los números detenidos\n\n"
    "*── Seguimiento + Cupones ──*\n"
