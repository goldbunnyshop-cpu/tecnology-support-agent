...
async def webhook_handler(request: Request):
    ...
    try:
        ...
        for msg in mensajes:
            ...
            # Detectar tipo de dispositivo (para context específico)
