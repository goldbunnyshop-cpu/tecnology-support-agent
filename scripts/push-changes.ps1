# Script para hacer push de cambios con token de GitHub
...
git add agent/leads.py agent/main.py

Write-Host "Haciendo commit..." -ForegroundColor Cyan
git commit -m "fix: validar estructura JSON y agregar skip para convertidos"
